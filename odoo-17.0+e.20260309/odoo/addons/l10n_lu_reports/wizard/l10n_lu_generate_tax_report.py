...
class L10nLuGenerateTaxReport(models.TransientModel):
    ...
    def _add_yearly_fields(self, form, options):
        ...
        if form.get('369') or form.get('368'):
            ...
            elif form.get('368')['value'] < form.get('369')['value']:
        ...
        elif (form.get('163') and not form.get('164') and not form.get('165')) or (float_compare(val_163, val_164 + val_165, precision_digits=2) != 0):
