...
class GeneralLedgerCustomHandler(models.AbstractModel):
    ...
    def _l10n_ro_saft_check_partner_values(self, values):
        ...
        descriptions = {
            'partner_city_missing': (_('Partners should have their city.'), False),
            'partner_country_missing': (_('Partners should have a country'), False),
            'partner_vat_doesnt_match_country': (_('Partners\' VAT prefix should correspond to their country.'), False),
            'partner_registry_incorrect': (_('Some partners have missing or invalid CUI numbers in `Company Registry`. Example of a valid CUI: 18547290'), False),
            'partner_vat_incorrect': (_('Some partners have invalid VAT numbers. Example of a valid VAT: RO18547290'), False),
            'partner_vies_failed': (_('The VAT numbers for the following partners failed the VIES check:'), False),
            'partner_missing_name': (_('These partners are missing a name:'), True),
        }
        return [
            {
                ...
                'action_params': partners.ids,
                'critical': descriptions[key][1],
            }
