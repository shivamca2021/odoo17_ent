    ...
    steps: () => [
        ...
        },
        {
            ...
            run: function() {
                ...
                const nit_id = $('select[name="l10n_latam_identification_type_id"] option:contains("NIT")');
                ...
                const obligation_id = $('select[name="l10n_co_edi_obligation_type_ids"] option:contains("R-99-PN")');
        ...
        },
        {
            ...
            trigger: 'div .o_website_sale_checkout',
            run: () => {},
        }
    ],
});
    ...
    steps: () => [
        ...
        },
        {
            ...
            run: function() {
                ...
                $('input[name="street"]').val('SO1 Billing Street, 33');
                $('input[name="zip"]').val('10000');
                const civil_id = $('select[name="l10n_latam_identification_type_id"] option:contains("Registro Civil")');
