    ...
    def create_record(self, documents=None):
        ...
        if self.create_model.startswith('account.move'):
            ...
            for document in documents:
                ...
                if self.move_type in ('in_invoice', 'in_refund') and partner and 'property_purchase_currency_id' in partner:
                    supplier_currency = partner.with_company(document.company_id).property_purchase_currency_id
                    if supplier_currency:
                        creation_context['default_currency_id'] = supplier_currency
