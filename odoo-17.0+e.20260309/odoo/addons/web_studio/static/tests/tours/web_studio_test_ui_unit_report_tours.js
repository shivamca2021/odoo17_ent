...
registry
    ...
    .add("web_studio.test_disable_fields_commands_when_unavailable", {
        ...
        steps: () => [
            ...
            {
                trigger: ".oe-powerbox-wrapper .oe-powerbox-commandName",
                run: (target) => {
                    const commands = Array.from(
                        document.querySelectorAll(".oe-powerbox-commandName")
                    ).map((e) => e.textContent);
...
registry.category("web_tour.tours").add("web_studio.test_edit_header_only_company", {
    ...
    steps: () => [
        ...
        },
        {
            ...
            run: "text studio company id",
        },
        {
            trigger: ".o_model_field_selector_item_title",
            run: "click",
        },
        {
            trigger:
