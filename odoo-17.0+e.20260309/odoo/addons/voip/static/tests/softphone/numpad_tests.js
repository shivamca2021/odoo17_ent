...
QUnit.test("Cursor is taken into account when clicking Backspace.", async (assert) => {
    start();
    await click(".o_menu_systray button[title='Open Softphone']");
    await click("button[title='Open Numpad']");
...
QUnit.test(
    "Selection starting at the beginning is removed when clicking Backspace.",
    async (assert) => {
        start();
        await click(".o_menu_systray button[title='Open Softphone']");
        await click("button[title='Open Numpad']");
...
QUnit.test("Cursor is taken into account when clicking on a key.", async (assert) => {
    start();
    await click(".o_menu_systray button[title='Open Softphone']");
    await click("button[title='Open Numpad']");
