...
export class ThankYouDialog extends Component {
    setup() {
        ...
        let defaultMessage = _t("You will receive the final signed document by email.");
        if (this.signInfo.get("companyCountryCode") === "US") {
            ...
            defaultMessage = _t("You will receive the final signed document by email. You may also request a paper copy from the sender.");
        }
