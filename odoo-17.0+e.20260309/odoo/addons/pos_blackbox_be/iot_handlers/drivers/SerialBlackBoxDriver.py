...
class BlackBoxDriver(SerialDriver):
    ...
    def _send_to_blackbox(self, packet, connection):
        ...
        :return: the response to the message sent
        :rtype: bytearray
        """
        ...
        try:
            ...
            if len(buffer) and buffer[0:1] == ACK:
                ...
                # When the blackbox is off or poorly connected its adaptor is still detected but always
                # replies with empty bytestrings b''
