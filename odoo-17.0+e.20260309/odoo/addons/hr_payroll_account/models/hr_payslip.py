...
class HrPayslip(models.Model):
    ...
    def _action_create_account_move(self):
        ...
        todays_date = fields.Date.context_today(self)
        if self.company_id.batch_payroll_move_lines:
            ...
            for slip in payslips_to_post:
                all_slip_mapped_data[slip.struct_id.journal_id.id][slip.date or todays_date] |= slip
            all_slip_mapped_data = [all_slip_mapped_data]
        else:
            all_slip_mapped_data = [{
                slip.struct_id.journal_id.id: {
                    slip.date or todays_date: slip
                }
            } for slip in payslips_to_post]
