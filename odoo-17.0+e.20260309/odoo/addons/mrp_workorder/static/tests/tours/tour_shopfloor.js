...
registry.category("web_tour.tours").add("test_shop_floor_my_wo_filter_with_pin_user", {
    ...
    steps: () => [
        ...
        { trigger: ".o_control_panel_actions button:contains(My WO).active", run() {} },
        {
        ...
        ...stepUtils.enterPIN("41213"),
        { trigger: ".o_admin_user:contains(Queen Elsa)", run() {} },
        {
        ...
        { trigger: ".o_mrp_employees_panel li:contains(John Snow)" },
        { trigger: ".o_admin_user:contains(John Snow)", run() {} },
        {
            trigger: ".o_mrp_display_record:contains(TEST/00002 - Build the Snowman)",
            run: () => {
                const currentEmployeeEl = document.querySelector(".o_admin_user div.fw-bold");
...
registry.category("web_tour.tours").add("test_partial_backorder_with_multiple_operations", {
    test: true, steps: () => [
        {
            content: "Make sure workcenter is available",
            trigger: "button:has(input[name='AssemblyLine'])",
            run: "click",
        },
        {
            content: "Confirm workcenter",
        ...
        {
            trigger:
                ".o_mrp_display_record:has(.card-title:contains(MOBACK-002 - op2)) .o_mrp_record_line:contains(3.00)",
            run: () => {},
        },
        {
            trigger:
        ...
        {
            trigger:
                ".o_mrp_display_record:has(.card-title:contains(MOBACK-002 - op3)) .o_mrp_record_line:contains(5.00)",
            run: () => {},
        },
    ]
})
