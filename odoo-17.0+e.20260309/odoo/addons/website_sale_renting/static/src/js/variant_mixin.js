...
VariantMixin._onChangeCombination = function (ev, $parent, combination) {
    ...
    const productTemplateId = document.querySelector('.product_template_id').value;
    // Only update pricing table if combination of root product changes
    if (
        pricingTable
        && productTemplateId
        && combination.product_template_id === parseInt(productTemplateId)
    ) {
