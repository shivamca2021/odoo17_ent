...
class TestEdiXmls(TestPeEdiCommon):
    ...
    def test_invoice_simple_case(self):
        with freeze_time(self.frozen_today), \
            ...
            self.assert_xml(current_etree, 'l10n_pe_edi_simple_invoice')
    ...
    def test_refund_simple_case(self):
        with freeze_time(self.frozen_today), \
            ...
            current_etree = self.get_xml_tree_from_string(edi_xml)
            self.assert_xml(current_etree, 'l10n_pe_edi_simple_credit_note')
    ...
    def test_debit_note_simple_case(self):
        with freeze_time(self.frozen_today), \
            ...
            current_etree = self.get_xml_tree_from_string(edi_xml)
            self.assert_xml(current_etree, 'l10n_pe_edi_simple_debit_note')
    ...
    def test_invoice_payment_term_detraction_case(self):
        ...
        edi_xml = self.edi_format._l10n_pe_edi_unzip_edi_document(zip_edi_str)
        current_etree = self.get_xml_tree_from_string(edi_xml)
        self.assert_xml(current_etree, 'l10n_pe_edi_invoice_payment_term_detraction_case')
    ...
    def test_invoice_detraction_with_decimal(self):
        ...
        edi_xml = self.edi_format._l10n_pe_edi_unzip_edi_document(zip_edi_str)
        current_etree = self.get_xml_tree_from_string(edi_xml)
        self.assert_xml(current_etree, 'l10n_pe_edi_invoice_detraction_with_decimal')
    ...
    def test_invoice_detraction_with_decimal_foreign_currency(self):
        ...
        edi_xml = self.edi_format._l10n_pe_edi_unzip_edi_document(zip_edi_str)
        current_etree = self.get_xml_tree_from_string(edi_xml)
        self.assert_xml(current_etree, 'l10n_pe_edi_invoice_detraction_with_decimal_foreign_currency')
    ...
    def test_low_unit_price_with_higher_decimal_precision(self):
        ...
        with freeze_time(self.frozen_today), \
            ...
            current_etree = self.get_xml_tree_from_string(edi_xml)
            self.assert_xml(current_etree, 'l10n_pe_edi_low_unit_price_with_higher_decimal_precision')
